...
fun ViewCheckOutsScreen(
    ...
    viewModel: ViewCheckOutsScreenViewModel = koinViewModel(),
) {
    val todayCheckOuts by viewModel.todayCheckOuts.collectAsStateWithLifecycle()
...
@Composable
private fun CheckOutsList(todayCheckOuts: List<RoomWithCustomersModel>) {
    LazyColumn(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp),
