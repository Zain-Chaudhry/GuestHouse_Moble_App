...
fun ViewBookingScreen(
    ...
    viewModel: ViewBookingScreenViewModel = koinViewModel(),
) {
...
@Composable
private fun ViewBookingList(todayCheckIns: List<com.example.diamondguesthouse.domain.models.RoomWithCustomersModel>) {
    LazyColumn(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp),
